...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> getEarthquakes(String requestUrl) {
        ...
        ArrayList<Earthquake> earthquakes = extractFeatures(jsonResponse);
    ...
    public static ArrayList<Earthquake> extractFeatures(String jsonResponse) {
